...
<nav>
    <a href="event.html"><i class="fa-solid fa-house"></i>BACK</a>
</nav>
<div class="container">
    ...
    $records = mysqli_query($con, "SELECT * FROM u_event where e_id='$evid'");
    ...
    if ($records) {
        ...
        while ($row = mysqli_fetch_array($records)) {
            ...
            echo "<td>" . $row[4] . "</td>"; // EVENT PRICE
            echo "<td>" . $row[5] . "</td>"; // EVENT PRICE
            echo "<td>" . $row[6] . "</td>"; // EVENT PRICE
            echo "<td>" . $row[7] . "</td>"; // EVENT PRICE
            echo "<td>" . $row[8] . "</td>"; // EVENT PRICE
            echo "<td>" . $row[9] . "</td>"; // EVENT PRICE
            echo "</tr>";
        }
    } else {

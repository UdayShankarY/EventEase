...
<body>
    ...
    <nav>
    <a href="searchbydate.html"><i class="fa-solid fa-arrow-left"></i>BACK</a>
...
<?php
	...
	$records=mysql_query("select * from event where e_startdate='$evdt' or e_enddate='$evdt'");
?>
<div class="css">
<?php
if(mysql_num_rows($records) > 0) {
        ...
        echo "Records not found on date : $evdt<br><br><br><br><br>";

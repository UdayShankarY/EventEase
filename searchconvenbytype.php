...
<nav>
    <a href="searchconvenbytype.html"><i class="fa-solid fa-arrow-left"></i>BACK</a>
    <a href="conventional.html"><i class="fa-solid fa-house"></i></i>HOME</a>
            ...
            <div class="css">
                <table border="2"> <!-- Added quotes around border=2 -->
                    ...
                    <?php
                        ...
                        $records = mysqli_query($con, "SELECT * FROM avail_conven where c_type='$evtype'");
                        while ($row = mysqli_fetch_array($records)) {
                            echo "<tr>";
                            echo "<td><a href='bookconvensview.php?event_id=" . $row[0] . "'>" . $row[0] . "</a></td>";
                            echo "<td>" . $row[1] . "</td>";
                            echo "<td>" . $row[2] . "</td>";

...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<div class='label'>HALL ID:</div>";
        echo "<input type='text' class='readonly' value='" . $row["c_id"]. "' readonly><br><br>";
        echo "<div class='label'>HALL Name:</div>";
        echo "<input type='text'  class='readonly' value='" . $row["c_name"]. "' readonly><br><br>";
        echo "<div class='label'>HALL Type:</div>";
        echo "<input type='text'  class='readonly' value='" . $row["c_type"]. "' readonly><br><br>";
        echo "<div class='label'>Price:</div>";
        echo "<input type='text'  class='readonly' value='" . $row["c_price"]. "' readonly><br><br>";
        echo "<div class='label'>Location:</div>";
        echo "<input type='text'  class='readonly' value='" . $row["c_location"]. "' readonly><br><br>";

        echo "<div class='label'>capacity:</div>";
        echo "<input type='text'  class='readonly' value='" . $row["c_capacity"]. "' readonly><br><br>";
        echo "<a href='" . $row["c_image"] . "' target='_blank'>View Image</a><br><br>";

        echo "<button><a href='bookeventsview.php?event_id=" . $row["c_id"] . "' target='_blank'>Book Event</a></button><br><br>"; // Modified link
        echo "</div>"; // End event details

        echo "</div>"; // End event content

        echo "<div class='event-image'>";
        echo "<img  src='" . $row["c_image"] . "' alt='Event Image'>";

...
<body>
    ...
    if (isset($_GET['event_id'])) {
        ...
        $query = "SELECT * FROM avail_conven WHERE c_id = '$event_id'";
        ...
        if ($records && mysqli_num_rows($records) > 0) {
            ...
            $query1 = "SELECT * FROM regi_conven WHERE c_id = '$event_id'";
...
?>
    ...
    <div class="container">
        ...
        <form method="post" action="bookconvenverify.php" name="bookingForm" onsubmit="return validateForm()">
        ...
        <input type="text" name="evid" value="<?php echo $event_id; ?>" readonly>
            ...
            <div class="lables" >HALL LOCATION:</div><br>
                <input id="unique-id" name="cloc"  type="text"  readonly value="<?php echo isset($row['c_location']) ? $row['c_location'] : ''; ?>"></input>
            </label><br><br>

            <div class="lables" >HALL CAPACITY:</div><br>
                <input id="unique-id" name="ccapacity"  type="text"  readonly value="<?php echo isset($row['c_capacity']) ? $row['c_capacity'] : ''; ?>"></input>
            </label><br><br>
...
<script>
    ...
    document.getElementById("evdate").setAttribute("min", minDate);
            ...
            <div class="lables" >hall Description:</div><br>
                <textarea  name="evdis" required  type="text" placeholder="  Description" ></textarea>
            </label><br><br>

            <div class="lables">Current Date and Time:</div><br>
    <input type="text" id="dateTimeTextBox" name="bdatetime" required readonly> <br>
    ...
    <script>
        ...
        document.getElementById("dateTimeTextBox").value = formattedDateTime;
            ...
            <input  name="submit" value="book Hall" class='sbt' type="submit"  ></input>

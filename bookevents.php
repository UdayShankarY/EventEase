...
<div class="container">
    <div class="hero-image">
        <div class="hero-text">
            <h3>BOOK EVENTS</h3>
            <div class="css">
            <input type='hidden' name='onlydate' id='onlydate'>
                ...
                <table border=2>
                    ...
                    <h2 style="color:red; background:lightblue;">Click on Id to Book an Event<h2>
                    <?php
                        $con = mysqli_connect("localhost", "root", "", "ems");
                        $records = mysqli_query($con, "SELECT * FROM availevents1");
                        while ($row = mysqli_fetch_array($records)) {
                            echo "<tr>";
                            echo "<td><a href='bookeventsview.php?event_id=" . $row[0] . "'>" . $row[0] . "</a></td>"; // Check the column name for EVENT ID
                            echo "<td>" . $row[1] . "</td>"; // Check the column name for EVENT NAME
                            echo "<td>" . $row[2] . "</td>"; // Check the column name for EVENT TYPE
                            echo "<td>" . $row[3] . ".00rs</td>"; // Check the column name for EVENT PRICE

    ...
    <div class="container">
        <div class="hero-image">
            <div class="hero-text">
                ...
                // Perform SQL query
                $query = "SELECT * FROM u_event WHERE e_id = '$e_id'";
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    $c_mono = $row['c_mono'];
                    $c_add = $row['c_add'];
                    $e_booked_date_time = $row['e_booked_date_time'];
...
if (isset($_POST['cdatetime']) && !empty($_POST['cdatetime'])) {
    ...
    if ($birthdate > $today) {
        echo "<br><div class='sts'>STATUS : Event Approved. <br> event Booked on : $e_booked_date_time</div>";
        ...
        echo "<br><div class='sts'>STATUS : event ended on ($e_date).<br> event Booked on : $e_booked_date_time</div>";
        ...
        echo "<br><div class='sts'> STATUS : today event ($e_date)<br> event Booked on : $e_booked_date_time</div>";

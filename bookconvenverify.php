...
<body>
<div class="heading">
    COVENTIONAL HALL MANAGEMENT SYSTEM
</div>
<nav>
...
<center>
    <div class="hero-image">
      ...
      $cost_mono = $_POST['costmobileno'];
      $cost_add = $_POST['costadd'];
      $e_date = $_POST['evdate'];
      $c_dis = $_POST['evdis'];
      $c_date_time = $_POST['bdatetime'];
      ...
      if (!$result) {
          ...
          if (mysqli_num_rows($result) > 0) {
              ...
              mysqli_query($con, "INSERT INTO regi_conven VALUES ('$c_id','$c_name','$c_type','$c_price','$c_loc','$c_capacity','$cost_name','$cost_mono','$cost_add','$e_date','$c_dis','$c_date_time')");
              echo "<center><div class='invoice'>
              <h3>New HALL Booked Successfully......!</h3><br><br>
              <h2>INVOICE</h2>
              <div class='details'>
                  <table border=1>
                      <tr>
                      ...
                      <tr>
                          <td><strong>Hall Booked on</strong></td>
                          <td>$c_date_time</td>
                      </tr>
                  </table>
              </div>

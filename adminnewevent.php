...
<body>
<div class="heading">EVENT MANAGEMENT SYSTEM</div>
<nav>
    ...
    <div class="hero-image">
        <div class="hero-text">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                <div class="newevent">
                    <h2><i class="fa-solid fa-plus"></i> NEW EVENT</h2>
                    <br>
                    <label>
                <div class="lables" >EVENT ID:</div><br>
                    <input id="unique-id" name="evid"  type="text"  placeholder="EVENT ID" ></input>
            </label><br><br>
            <label>
                <div class="lables" >EVENT NAME:</div><br>
                <input type="text" name="evname" required placeholder="EVENT NAME" ></input>
            </label><br><br>
            <label>
                <div class="lables" >EVENT TYPE:</div><br>
                <select name="evtype" required>
            ...
            <label>
                ...
                <input type="text" name="evprice" placeholder="Event Price" ></input>
            </label><br><br>
...
if ($uploadOk == 0) {
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        $sql = "INSERT INTO availevents1 (e_id, e_type, e_name, e_price, e_image) 
                VALUES ('$e_id', '$e_type', '$e_name', '$e_price', '$target_file')";

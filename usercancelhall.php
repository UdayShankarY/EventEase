...
<body>
    ...
    <nav>
        <a href="usercancelhall.html"><i class="fa-solid fa-arrow-left"></i>BACK</a>
        <a href="conven.html"><i class="fa-solid fa-house"></i></i>HOME</a>
...
<?php
	...
	mysql_query("delete from regi_conven where c_id='$c_id'");

    $sql = "INSERT INTO avail_conven (c_id, c_name, c_type, c_price, c_location, c_capacity, c_image) 
    VALUES ('$c_id', '$c_name', '$c_type', '$c_price', '$c_loc', '$c_capacity', '$')";

?>
<div class="css">
<?php
                   
                        echo "Records on id : $c_id deleted...!<br><br><br><br><br>";

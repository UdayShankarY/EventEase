...
<body>
    ...
    <nav>
        <a href="alterevent.html"><i class="fa-solid fa-arrow-left"></i>BACK</a>
...
<?php
	...
	mysql_query("update availevents1 set e_id='$evid',e_name='$name',e_type='$type',e_price='$price',e_image='$image' where e_id='$evid'");

    echo "Records on id : $evid Updated...!<br><br><br><br><br>";
